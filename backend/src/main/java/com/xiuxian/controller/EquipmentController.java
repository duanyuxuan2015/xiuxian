...
class EquipmentAdminController {
     ...
     */
    @PostMapping
    public Result<Long> create(@Valid @RequestBody com.xiuxian.dto.request.EquipmentCreateRequest request) {
    ...
    public Result<Void> update(
            ...
            @Valid @RequestBody com.xiuxian.dto.request.EquipmentUpdateRequest request) {
