 ...
 * 创建丹方请求DTO
 */
public class PillRecipeCreateRequest {

    @NotBlank(message = "丹方名称不能为空")
    @Size(max = 100, message = "丹方名称长度不能超过100个字符")
    private String recipeName;

    @NotNull(message = "产出丹药不能为空")
    private Long pillId;
    ...
    @NotNull(message = "炼制时长不能为空")
    @Min(value = 1, message = "炼制时长最小为1")
    private Integer duration;

    @NotNull(message = "丹方品阶不能为空")
